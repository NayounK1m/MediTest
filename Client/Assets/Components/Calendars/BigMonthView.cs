		...
		private void EnableSelection() {
			...
			if (m_StartTouchPosition != Vector2.zero) {
				...
				if (m_FirstSelectedCell != null) {
					...
					Debug.Log(FirstDateOfSelection.ToString("yyyy/MM/dd") + LastDateOfSelection.ToString("yyyy/MM/dd"));
					FirstDate = FirstDateOfSelection.ToString("yyyy/MM/dd");
					LastDate = LastDateOfSelection.ToString("yyyy/MM/dd");
				}
			}
